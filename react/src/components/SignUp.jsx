        ...
        <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-black/40 border border-white/20 rounded-full text-white placeholder-white/50 focus:outline-none focus:ring-2 focus:ring-pink-500/50 focus:border-transparent"
              ...
              <div className="flex justify-center space-x-4 mt-6">
                <button className="w-12 h-12 bg-black/20 backdrop-blur-sm rounded-full flex items-center justify-center hover:bg-white/20 transition-all duration-300">
          ...
          <div className="bg-black/30 backdrop-blur-xl rounded-3xl p-8 border border-white/10 relative">
            ...
            <div className="relative z-10">
              <div className="mb-8">
                <p className="text-white text-2xl">What's our</p>
                <h2 className="text-4xl font-bold text-white">Industrialists Said.</h2>
              </div>
